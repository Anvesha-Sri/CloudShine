...
const weatherQuotes = {
    ...
    Mist:         { icon: '☔', text: 'When the world turns misty, the sky is just keeping its mysteries close.' },
    Fog:          { icon: '😶‍🌫️', text: 'When the world turns foggy, the sky is just keeping its mysteries close.' },
    Haze:         { icon: '🍃', text: 'Through the haze, the sky still has a story waiting to unfold.' },
    Smoke:        { icon: '💨', text: 'Even through the smoke, the sky holds on to its quiet beauty.' },
